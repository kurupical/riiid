...
print(roc_auc_score(df_oof2["target"].values, df_oof2["predict_lgbm"].values))

print(roc_auc_score(df_oof2["target"].values, df_oof2["predict_lgbm"].values*0.9 + df_oof2["predict"].values*0.1))