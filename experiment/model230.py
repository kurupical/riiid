...
class SAKTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        idx_dict = {
            ...
            "previous_answer_index_content_id_past500": 9,
            "previous_answer_content_id_past500": 10,
        ...
        return {
            ...
            "previous_answer_index_content_id": get_data(key="previous_answer_index_content_id_past500"),
            "previous_answer_content_id": get_data(key="previous_answer_content_id_past500"),
...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        self.prev_ans_idx_embedding = nn.Embedding(502, embed_dim_middle_cat)
...
def main(params: dict,
    ...
    column_config = {
        ...
        "previous_answer_index_content_id_past500": {"type": "category"},
        "previous_answer_content_id_past500": {"type": "category"},
    ...
    if not load_pickle or is_debug:
        ...
        df = df.rename(columns={"previous_answer_index_content_id": "previous_answer_index_content_id_past500",
                                "previous_answer_content_id": "previous_answer_content_id_past500"})
        df = df[["user_id", "content_id", "content_type_id", "part", "user_answer", "answered_correctly",
                 ...
                 "previous_answer_index_content_id_past500", "previous_answer_content_id_past500", "row_id",
    ...
    os.makedirs("../input/feature_engineering/model230", exist_ok=True)
    if not is_debug and not load_pickle:
        with open(f"../input/feature_engineering/model230/train.pickle", "wb") as f:
            pickle.dump(dataset_train, f)
        with open(f"../input/feature_engineering/model230/val.pickle", "wb") as f:
            pickle.dump(dataset_val, f)

    if not is_debug and load_pickle:
        with open(f"../input/feature_engineering/model230/train.pickle", "rb") as f:
            dataset_train = pickle.load(f)
        with open(f"../input/feature_engineering/model230/val.pickle", "rb") as f:
