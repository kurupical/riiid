...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    for column in ["user_id", "content_id", ("user_id", "question_id")]:
    ...
    for column in ["user_id", "question_id", "part", ("user_id", "part")]:
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    df = df.drop(["user_answer", "tags", "type_of", "bundle_id", "previous_5_ans", "question_id"], axis=1)
