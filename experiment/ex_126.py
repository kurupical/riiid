from feature_engineering.feature_factory import \
    ...
    StudyTermEncoder, \
    ListeningReadingEncoder

from experiment.common import get_logger, total_size
import pandas as pd
from model.lgbm import train_lgbm_cv, train_lgbm_cv_newuser_with_tta
...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["part"] = {
        "ListeningReadingEncoder": ListeningReadingEncoder(is_partial_fit=True)
    }
    ...
    feature_factory_dict[("user_id", "is_listening")] = {
        "UserContentRateEncoder": UserContentRateEncoder(column=["user_id", "is_listening"],
                                                         rate_func="elo")
    }
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    print(model_id)
    train_lgbm_cv_newuser_with_tta(df,
