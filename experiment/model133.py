...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2):
        ...
        self.embedding = nn.Embedding(4, 32, padding_idx=0)
        self.user_answer_embedding = nn.Embedding(6, 32, padding_idx=0)
        self.prior_question_had_explanation_embedding = nn.Embedding(4, 32, padding_idx=0)
        self.e_embedding = nn.Embedding(n_skill + 1, 256, padding_idx=0)
        self.part_embedding = nn.Embedding(8, 32, padding_idx=0)
        self.elapsed_time_embedding = nn.Embedding(302, 32, padding_idx=0)
        self.duration_previous_content_embedding = nn.Embedding(302, 32, padding_idx=0)
        ...
        self.cat_embedding = CatEmbedding(embed_dim=embed_dim)
