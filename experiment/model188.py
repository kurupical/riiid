...
class SAKTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # encoder
        content_id_encoder = q[:-1]
        elapsed_time_out = elapsed_time[1:]
        label_decoder = qa[:-1] + 2  # 1: lecture 2: not correct 3: correct
        prior_q_out = prior_q[1:] # 0: nan, 1: lecture 2: False 3: True
        ua_out = ua[:-1] + 1 # 0: nan, 1: lecture, 2~5: answer
...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        self.rate_diff_embedding = ContEmbedding(input_dim=1, embed_dim=emb2, seq_len=max_seq-1)
