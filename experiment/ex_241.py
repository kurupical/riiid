...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    df = df.drop(["user_answer", "tags", "type_of", "bundle_id", "previous_5_ans",
                  "tag", "content_type_id", "prior_question_had_explanation",
                  "question_id", "correct_answer",
                  "mean_duration_previous_content_cap100k_by___user_id____prior_question_had_explanation__",
                  "mean_duration_previous_content_cap100k_by_part",
                  "mean_duration_previous_content_cap100k_by_content_id",
                  "mean_study_time_by_user_id", "mean_study_time_by___user_id____part__"],
