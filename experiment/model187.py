...
class SAKTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x = (qa[:-1].copy()-2) * q[:-1] # 1: lecture 2: not correct 3: correct
        x[x < 0] = 0
...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        self.embedding = nn.Embedding(n_skill*2 + 1, 32)
        ...
        encoder_layer = nn.TransformerEncoderLayer(d_model=embed_dim_all, nhead=num_heads)
