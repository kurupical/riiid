...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        embed_dim_cat_all = embed_dim_small_cat*10 + embed_dim
        ...
        self.elapsed_time_embedding = nn.Embedding(302, embed_dim_small_cat)
        self.duration_previous_content_embedding = nn.Embedding(302, embed_dim_small_cat)
        self.container_embedding = nn.Embedding(302, embed_dim_small_cat)
        self.prev_ans_idx_embedding = nn.Embedding(302, embed_dim_small_cat)
        self.prev_ans_content_id_embedding = nn.Embedding(4, embed_dim_small_cat)
        self.timediff_elapsedtime_embedding = nn.Embedding(502, embed_dim_small_cat)
