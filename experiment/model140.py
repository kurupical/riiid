...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2):
        ...
        self.study_time_embedding = nn.Embedding(302, 32)
        self.study_time_diff_user_id_embedding = nn.Embedding(302, 32)
        self.past2_ts_delta_embedding = nn.Embedding(302, 32)
        self.past3_ts_delta_embedding = nn.Embedding(302, 32)
        self.past4_ts_delta_embedding = nn.Embedding(302, 32)
        self.past5_ts_delta_embedding = nn.Embedding(302, 32)
        self.rate_diff_bin_embedding = nn.Embedding(502, 32)
