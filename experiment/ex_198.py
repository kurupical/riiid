...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    for column in ["user_id", "content_id", "uc_rate"]:
    ...
    feature_factory_dict["user_id"]["UserRateBinningEncoder"] = UserRateBinningEncoder()
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    df = df.drop(["user_answer", "tags", "type_of", "bundle_id", "previous_5_ans", "uc_rate"], axis=1)
