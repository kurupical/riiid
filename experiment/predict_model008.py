...
from experiment.model013 import SAKTModel, SAKTDataset
warnings.filterwarnings("ignore")

model_dir = "../output/model013/20201204140455"
device = "cuda"
...
def run(debug,
    ...
    for (df_test, df_sample_prediction) in iter_test:
        ...
        dataset_val = SAKTDataset(group, 13782, predict_mode=True, max_seq=params["max_seq"])
