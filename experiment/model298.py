...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        self.lstm_block = nn.Sequential(
            LSTMBlock(input_dim=embed_dim_all, embed_dim=embed_dim_all//2, dropout=dropout),
            LSTMBlock(input_dim=embed_dim_all*6//4, embed_dim=embed_dim_all*3//4, dropout=dropout)
        )
