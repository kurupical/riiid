...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["user_id"]["CounterContentTypeId"] = Counter(groupby_column="user_id",
                                                                      agg_column="content_type_id",
                                                                      categories=[0, 1])
    feature_factory_dict["user_id"]["CounterPart"] = Counter(groupby_column="user_id",
                                                             agg_column="part",
                                                             categories=[2, 5])
