...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2):
        ...
        self.transformer_enc = nn.TransformerEncoder(encoder_layer=encoder_layer, num_layers=3)
        decoder_layer = nn.TransformerDecoderLayer(d_model=embed_dim, nhead=num_heads)
        self.transformer_dec = nn.TransformerDecoder(decoder_layer=decoder_layer, num_layers=3)
