...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    for column in ["user_id", "content_id", ("user_id", "kmeans_tags40")]:
    ...
    feature_factory_dict["user_id"]["UserContentRateEncoder"] = UserContentRateEncoder(column="user_id",
                                                                                       rate_func="elo")
    feature_factory_dict["user_id"]["UserTagsContentRateEncoder"] = UserContentRateEncoder(column=["user_id", "kmeans_tags40"],
                                                                                           rate_func="elo")
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    df = pd.merge(df, df_question[["question_id", "kmeans_tags40"]], how="left")
