from feature_engineering.feature_factory import \
    ...
    ContentIdTargetEncoderAggregator, \
    SessionEncoder, \
...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["user_id"]["PreviousAnswer2"] = PreviousAnswer2(groupby="user_id",
                                                                         ...
                                                                         is_debug=is_debug,
                                                                         model_id=model_id)
    feature_factory_dict["user_id"]["SessionEncoder"] = SessionEncoder()
    ...
    feature_factory_dict["post"] = {
        "ContentIdTargetEncoderAggregator": ContentIdTargetEncoderAggregator()
    }
