...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["user_id"]["QuestionQuestionTableEncoder"] = QuestionQuestionTableEncoder(model_id=model_id,
                                                                                                   is_debug=is_debug,
                                                                                                   past_n=100)
    feature_factory_dict["user_id"]["UserAnswerLevelEncoder"] = UserAnswerLevelEncoder(model_id=model_id,
                                                                                       is_debug=is_debug,
                                                                                       past_n=100)
    feature_factory_dict["user_id"]["WeightDecayTargetEncoder"] = WeightDecayTargetEncoder(column="user_id")
    ...
    feature_factory_dict[("user_id", "tags1")] = {
        "UserContentRateEncoder": UserContentRateEncoder(column=["user_id", "tags1"],
                                                         rate_func="elo")
    }
    feature_factory_dict[("user_id", "tags2")] = {
        "UserContentRateEncoder": UserContentRateEncoder(column=["user_id", "tags2"],
                                                         rate_func="elo")
    }
