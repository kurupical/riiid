...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    df["content_id_user_answer"] = df["content_id"].astype(str) + "_" + df["user_answer"].astype(str)
    df["cu_shift1"] = df.groupby("user_id")["content_id_user_answer"].shift(1)
    df["cu_shift2"] = df.groupby("user_id")["content_id_user_answer"].shift(2)
    df["cu_shift3"] = df.groupby("user_id")["content_id_user_answer"].shift(3)
    df["cu_shift4"] = df.groupby("user_id")["content_id_user_answer"].shift(4)
    df["cu_shift5"] = df.groupby("user_id")["content_id_user_answer"].shift(5)

    df["cu1_mean"] = df.groupby("cu_shift1")["answered_correctly"].transform("mean")
    df["cu2_mean"] = df.groupby("cu_shift2")["answered_correctly"].transform("mean")
    df["cu3_mean"] = df.groupby("cu_shift3")["answered_correctly"].transform("mean")
    df["cu4_mean"] = df.groupby("cu_shift4")["answered_correctly"].transform("mean")
    df["cu5_mean"] = df.groupby("cu_shift5")["answered_correctly"].transform("mean")
    ...
    df = df.drop(["user_answer", "tags", "type_of", "bundle_id", "previous_5_ans", "content_id_user_answer",
                  "cu_shift1", "cu_shift2", "cu_shift3", "cu_shift4", "cu_shift5"], axis=1)
