...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2):
        ...
        self.user_answer_embedding = nn.Embedding(6, 64)
        self.prior_question_had_explanation_embedding = nn.Embedding(4, 64)
        self.e_embedding = nn.Embedding(n_skill + 1, 512)
        self.part_embedding = nn.Embedding(8, 64)
