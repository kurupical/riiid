...
class SelfAttentionLayer(nn.Module):
    def __init__(self, embed_dim, num_heads, dropout, has_ffn):
...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2):
        ...
        self.multi_att_enc_self1 = SelfAttentionLayer(embed_dim=embed_dim, num_heads=num_heads, dropout=dropout, has_ffn=True)
        self.multi_att_enc_self2 = SelfAttentionLayer(embed_dim=embed_dim, num_heads=num_heads, dropout=dropout, has_ffn=True)
        self.multi_att_dec_self1 = SelfAttentionLayer(embed_dim=embed_dim, num_heads=num_heads, dropout=dropout, has_ffn=False)
        self.multi_att_dec_self2 = SelfAttentionLayer(embed_dim=embed_dim, num_heads=num_heads, dropout=dropout, has_ffn=False)
