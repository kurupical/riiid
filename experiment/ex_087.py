...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["user_id"]["QuestionLectureTableEncoder"] = QuestionLectureTableEncoder2(model_id=model_id,
                                                                                                  is_debug=is_debug,
                                                                                                  past_n=10)
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*")[8:]:
    break
    print(fname)
    if is_debug:
