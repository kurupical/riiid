...
from experiment import model288_4  # lstm2
...
model_dir = {
    ...
    "model288_4": "../output/model288_4/20210106121503",
...
class KurupicalModel:
    def __init__(self,
        ...
        self.models = {
            ...
            "model288_4": get_model(model_dir=model_dir["model288_4"], model_class=model288_4.SAKTModel),
