...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    feature_factory_dict["user_id"]["QuestionLectureTableEncoder2"] = QuestionLectureTableEncoder2(model_id=model_id,
                                                                                                   ...
                                                                                                   past_n=100,
                                                                                                   min_size=100)
    feature_factory_dict["user_id"]["QuestionQuestionTableEncoder"] = QuestionQuestionTableEncoder2(model_id=model_id,
                                                                                                    is_debug=is_debug,
                                                                                                    past_n=100,
                                                                                                    min_size=300)
...
for fname in glob.glob("../input/riiid-test-answer-prediction/split10/*"):
    ...
    print(model_id)
    use_columns = pd.read_csv("../output/ex_131/20201125230514/imp_train_0.csv")["feature"].values[:40].tolist()
