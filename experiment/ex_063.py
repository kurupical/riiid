...
def make_feature_factory_manager(split_num, model_id=None):
    ...
    for column in ["user_id", "content_id", "part", "prior_question_had_explanation",
        ...
        if type(column) == str:
            feature_factory_dict[column] = {
                ...
                "TargetEncoder": TargetEncoder(column=column, is_partial_fit=is_partial_fit, initial_score=0.65, initial_weight=10)
            }
        else:
            feature_factory_dict[column] = {
                "CountEncoder": CountEncoder(column=list(column), is_partial_fit=is_partial_fit),
                "TargetEncoder": TargetEncoder(column=list(column), is_partial_fit=is_partial_fit, initial_score=0.65, initial_weight=10)
            }
    ...
    """
    feature_factory_dict["content_id"]["MeanAggregatorContentLevel"] = MeanAggregator(column="content_id",
                                                                                      agg_column="content_level_content_id",
                                                                                      remove_now=False)
    """
    ...
    feature_factory_dict["user_count_bin"]["TargetEncoder"] = TargetEncoder(column="user_count_bin", initial_score=0.65, initial_weight=10)
    feature_factory_dict[("user_id", "user_count_bin")] = {
        "CountEncoder": CountEncoder(column=["user_id", "user_count_bin"]),
        "TargetEncoder": TargetEncoder(column=["user_id", "user_count_bin"], initial_score=0.65, initial_weight=10)
    }
    feature_factory_dict[("content_id", "user_count_bin")] = {
        "CountEncoder": CountEncoder(column=["content_id", "user_count_bin"]),
        "TargetEncoder": TargetEncoder(column=["content_id", "user_count_bin"], initial_score=0.65, initial_weight=10)
    }
    feature_factory_dict[("prior_question_had_explanation", "user_count_bin")] = {
        ...
        "TargetEncoder": TargetEncoder(column=["prior_question_had_explanation", "user_count_bin"], initial_score=0.65, initial_weight=10)
    }
    ...
    feature_factory_dict[("part", "prior_question_elapsed_time_bin")] = {
        ...
        "TargetEncoder": TargetEncoder(column=["part", "prior_question_elapsed_time_bin"], initial_score=0.65, initial_weight=10)
    }
