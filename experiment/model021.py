...
def main(params: dict):
    ...
    df = df[["user_id", "content_id", "content_type_id", "part", "user_answer", "answered_correctly", "timestamp"]]
    ...
    scheduler = get_linear_schedule_with_warmup(optimizer,
                                                ...
                                                num_training_steps=len(dataloader_train) / params["batch_size"]
                                                )
