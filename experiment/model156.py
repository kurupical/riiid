...
class SAKTModel(nn.Module):
    def __init__(self, n_skill, max_seq=100, embed_dim=128, num_heads=8, dropout=0.2,
        ...
        self.n_skill = n_skill
        self.embed_dim = embed_dim
        embed_dim = emb2*9 + 256

        self.embedding = nn.Embedding(4, emb2)
        self.user_answer_embedding = nn.Embedding(6, emb2)
        self.prior_question_had_explanation_embedding = nn.Embedding(4, emb2)
        ...
        self.prev_ans_content_id_embedding = nn.Embedding(4, emb2)
