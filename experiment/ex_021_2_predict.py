...
model_dir = "../output/ex_021/20201019203510"
...
def run(debug,
    ...
    for model_id, fname in enumerate(glob.glob(files_dir)):
        ...
        feature_factory_manager.fit(df, all_predict_mode=True)
    ...
    for (df_test, df_sample_prediction) in iter_test:
        ...
        if len(df_test_prev) > update_record:
            ...
            feature_factory_manager.fit(df_test_prev, partial_predict_mode=True)
