...
class SAKTModel(nn.Module):
    ...
    def forward(self, item, device):
        ...
        timedelta_log10_cumsum = torch.log10(duration_previous_content_row.cumsum(dim=1)+1).long()
        timedelta_log10_cumsum = timedelta_log10_cumsum[:, -1].view(-1, 1) - timedelta_log10_cumsum
